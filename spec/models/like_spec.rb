...
RSpec.describe Like, type: :model do
  user = User.create(name: 'Tom', photo: 'https://bit.ly/48MSO1Y',
                     bio: 'Teacher from Mexico.', posts_counter: 3)
  post = Post.create(author: user, title: 'Title 1', text: 'First post from Prosper',
  ...
  describe '#update_post_likes_counter' do
    it 'Updates likes of the associated post' do
      like = Like.create(post:, author: user, author_id: user.id)
